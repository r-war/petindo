            ...
            <div class="tile">
                ...
                <form action="{{ route('admin.categories.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            <label for="parent">Color <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control jscolor" type="text" id="color" name="color" value="{{ $targetCategory->color }}" />
                        </div>  
                        <div class="form-group">
