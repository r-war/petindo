    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <form action="{{ route('admin.menu.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            ...
                            <select id=parent class="form-control custom-select mt-15 @error('parent_id') is-invalid @enderror" name="parent_id">
                                ...
                                @foreach($menu as $key => $menu)
                                    @if ($targetmenu->parent_id == $key)
                                        <option value="{{ $key }}" selected> {{ $menu }} </option>
                                    @else
                                ...
                                <div class="col-md-2">
                                    @if ($targetmenu->image != null)
                                        <figure class="mt-2" style="width: 80px; height: auto;">
                                            <img src="{{ asset('storage/'.$targetmenu->image) }}" id="menuImage" class="img-fluid" alt="img">
                                        </figure>
                                    @endif
                                </div>
                                <div class="col-md-10">
