...
<aside class="app-sidebar">
    <ul class="app-menu">
        ...
        <li>
            <a class="app-menu__item {{ Route::currentRouteName() == 'admin.menus.index' ? 'active' : '' }}"
        ...
        <li>
            <a class="app-menu__item {{ Route::currentRouteName() == 'admin.pages.index' ? 'active' : '' }}"
                href="{{ route('admin.pages.index') }}">
                <i class="app-menu__icon fa fa-file"></i>
                <span class="app-menu__label">Page</span>
            </a>
        </li>
        <li>
