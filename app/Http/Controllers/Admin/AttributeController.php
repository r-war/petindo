...
class AttributeController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if(!$attribute)
        {
            return $this->responseRedirectBack('Error occurred when creating attribute', 'error', true, true);
        }
    ...
    public function update(Request $request)
    {
        ...
        if(!$attribute)
        {
            return $this->responseRedirectBack('Error occurred when updating attribute', 'error', true, true);
        }
